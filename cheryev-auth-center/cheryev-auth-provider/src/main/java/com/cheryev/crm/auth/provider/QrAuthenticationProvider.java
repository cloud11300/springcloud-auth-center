package com.cheryev.crm.auth.provider;
...
public class QrAuthenticationProvider extends MyAbstractUserDetailsAuthenticationProvider {
    ...
    private QrUserDetailService userDetailsService;
    ...
    public void setUserDetailsService(QrUserDetailService userDetailsService) {
