package com.cheryev.crm.auth.filter;

import com.cheryev.crm.auth.token.PhoneAuthenticationToken;
import com.cheryev.crm.auth.token.QrAuthenticationToken;
...
public class MyLoginAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public static final String SPRING_SECURITY_RESTFUL_REDIRECT_URL = "redirect_uri";
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        String redirectUrl = obtainParameter(request, SPRING_SECURITY_RESTFUL_REDIRECT_URL);
